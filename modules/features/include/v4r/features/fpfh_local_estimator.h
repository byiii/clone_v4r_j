...
#ifndef V4R_FPFH_LOCAL_ESTIMATOR_H_
#define V4R_FPFH_LOCAL_ESTIMATOR_H_
...
class FPFHLocalEstimation : public LocalEstimator<PointInT>
{
...
template class V4R_EXPORTS FPFHLocalEstimation<pcl::PointXYZ>;
template class V4R_EXPORTS FPFHLocalEstimation<pcl::PointXYZRGB>;
}

#endif /* V4R_FPFH_LOCAL_ESTIMATOR_H_ */
