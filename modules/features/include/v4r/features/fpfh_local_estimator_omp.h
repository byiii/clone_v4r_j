...
#ifndef V4R_FPFH_LOCAL_ESTIMATOR_OMP_H_
#define V4R_FPFH_LOCAL_ESTIMATOR_OMP_H_
...
class FPFHLocalEstimationOMP : public LocalEstimator<PointInT>
{
...
template class V4R_EXPORTS FPFHLocalEstimationOMP<pcl::PointXYZ>;
template class V4R_EXPORTS FPFHLocalEstimationOMP<pcl::PointXYZRGB>;
}


#endif /* V4R_FPFH_LOCAL_ESTIMATOR_OMP_H_ */
